...
export class DepreciationController {
  ...
  calculateDepreciation(
    @Body() calculateDto: CalculateDepreciationDto,
  ...
  async recordDepreciation(
    ...
    // Use the enhanced service method that now returns a DepreciationEntryResponseDto
    return this?.depreciationService.recordDepreciation(assetId, date, recordAmount, note);
  }
