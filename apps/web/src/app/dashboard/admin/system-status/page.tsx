    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-6">
        ...
        <p className="text-gray-600">
          Monitor the health and status of all services in the application.
        </p>
      </div>
      ...
      <div className="mt-8 bg-white rounded-lg shadow-sm p-6">
        ...
        <p className="mb-3">
          This dashboard shows the real-time status of all microservices in the Qbit Accounting
          System. Each service exposes health check endpoints that provide detailed information
